...
import { apiFetch, getApiErrorMessage, getDisplayError } from '@/lib/api'
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setFieldErrors((prev) => ({ ...prev, ixcUser: '' }))
                          }}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setFieldErrors((prev) => ({ ...prev, ixcBaseUrl: '' }))
                        }}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setFieldErrors((prev) => ({ ...prev, ixcToken: '' }))
                        }}
