    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:flex lg:items-center lg:justify-center">
        ...
        <div className="relative z-10 w-full max-w-[540px] px-8">
          ...
          {/* Headline */}
          <h2 className="text-center text-[30px] font-bold leading-[1.2] tracking-tight text-white">
      ...
      <div className="relative flex w-1/2 items-center justify-center px-6 py-12 lg:px-12 xl:px-20">
